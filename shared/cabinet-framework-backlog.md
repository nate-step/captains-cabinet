...
- **Status:** Phase 1 + Phase 2 SHIPPED 2026-04-26. Phase 1: indexer + scaffold-entry + 24-block retro-fit + pre-commit freshness gate. Phase 2: query.sh keyword retrieval + pre-captain-dm UserPromptSubmit hook + 60s identical-block dedup + capability flag (Work officers wired; Personal pending CoS). Phase 3 (eval + 5-anchor fixture set + pre-/post-comparison) pending. Spec 042 v1 LANDED 2026-04-26. File artifacts + scripts only, zero schema reach. Reversible.
