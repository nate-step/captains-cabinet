...
- **Memory updated:** `feedback_security_regex_authoring.md` — this is 6th pre-tool-use-regex adversary round; Rule 1 quantified as "4-5 rounds typical for security-critical regex"; Rule 1 addendum added: Pass-N triage (bug/scope-gap/false-positive) with empirical-verify-before-regex-extend discipline.
